...
async function getWeeks(currentBorough, data) {
    let weeks = ['week1.json', 'week2.json', 'week3.json', 'week4.json', 'week5.json', 'week6.json', 'week7.json', 'week8.json',
        ...
        'week73.json', 'week74.json', 'week75.json'
    ]
    ...
    let chart = new Chart(ctx, {
        ...
        data: {
            labels: [
                ...
                ['Jan 17-', 'Jan 23'], ['Jan 24-', 'Jan 30'], ['Jan 31-', 'Feb 6']
            ],
            datasets: [{
...
function addMapFeatures(map) {
    ...
    map.on('load', async function() {
        ...
        let coronaData = await fetchData('week75.json');
        ...
        selectBorough(map, coronaData, 'weekly-cases', "Cases in Last Week", "Number of Cases from 31 Jan-6 Feb")
        ...
        selectBorough(map, coronaData, 'total-cases', "Total Cases", "Total Number of Cases to 10 Feb")
