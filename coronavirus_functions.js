...
async function getWeeks(currentBorough, data) {
    let weeks = ['week1.json', 'week2.json', 'week3.json', 'week4.json', 'week5.json', 'week6.json', 'week7.json', 'week8.json',
        ...
        'week65.json', 'week66.json', 'week67.json'
    ]
    ...
    let chart = new Chart(ctx, {
        ...
        data: {
            labels: [
                ...
                ['Nov 22-', 'Nov 28'], ['Nov 29-', 'Dec 5'], ['Dec 6-', 'Dec 12']
            ],
            datasets: [{
...
function addMapFeatures(map) {
    ...
    map.on('load', async function() {
        ...
        let coronaData = await fetchData('week67.json');
        ...
        selectBorough(map, coronaData, 'weekly-cases', "Cases in Last Week", "Number of Cases from 6-12 Dec")
        ...
        selectBorough(map, coronaData, 'total-cases', "Total Cases", "Total Number of Cases to 16 Dec")
