...
function addMapFeatures(map) {
    ...
    map.on('load', async function() {
        ...
        let coronaData = await fetchData('week73.json');
        ...
        selectBorough(map, coronaData, 'weekly-cases', "Cases in Last Week", "Number of Cases from 17-23 Jan")
        ...
        selectBorough(map, coronaData, 'total-cases', "Total Cases", "Total Number of Cases to 27 Jan")
