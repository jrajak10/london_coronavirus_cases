...
async function getWeeks(currentBorough, data) {
    let weeks = ['week1.json', 'week2.json', 'week3.json', 'week4.json', 'week5.json', 'week6.json', 'week7.json', 'week8.json',
        ...
        'week49.json', 'week50.json', 'week51.json', 'week52.json', 'week53.json', 'week54.json', 'week55.json', 'week56.json',
        'week57.json', 'week58.json', 'week59.json', 'week60.json', 'week61.json', 'week62.json', 'week63.json', 'week64.json',
        'week65.json', 'week66.json', 'week67.json', 'week68.json', 'week69.json', 'week70.json', 'week71.json', 'week72.json',
        'week73.json', 'week74.json', 'week75.json', 'week76.json', 'week77.json', 'week78.json', 'week79.json', 'week80.json'
    ]
    ...
    let chart = new Chart(ctx, {
        ...
        data: {
            labels: [
                ...
                ['Aug 30-', 'Sep 5'], ['Sep 6-', 'Sep 12'], ['Sep 13-', 'Sep 19'], ['Sep 20-', 'Sep 26'],
                ['Sep 27-', 'Oct 3'], ['Oct 4-', 'Oct 10'], ['Oct 11-', 'Oct 17'], ['Oct 18-', 'Oct 24'],
                ['Oct 25-', 'Oct 31'], ['Nov 1-', 'Nov 7'], ['Nov 8-', 'Nov 14'], ['Nov 15-', 'Nov 21'],
                ['Nov 22-', 'Nov 28'], ['Nov 29-', 'Dec 5'], ['Dec 6-', 'Dec 12'], ['Dec 13-', 'Dec 19'],
                ['Dec 20-', 'Dec 26'], ['Dec 27-', 'Jan 2'], ['Jan 3-', 'Jan 9'], ['Jan 10-', 'Jan 16'],
                ['Jan 17-', 'Jan 23'], ['Jan 24-', 'Jan 30'], ['Jan 31-', 'Feb 6'],  ['Feb 7-', 'Feb 13'],
                ['Feb 14-', 'Feb 20'], ['Feb 21-', 'Feb 27'],  ['Feb 28-', 'Mar 6'],  ['Mar 7-', 'Mar 13']
            ],
            datasets: [{
...
function addMapFeatures(map) {
    ...
    map.on('load', async function() {
        ...
        let coronaData = await fetchData('week80.json');
        ...
        selectBorough(map, coronaData, 'weekly-cases', "Cases in Last Week", "Number of Cases from 7-13 Mar")
        ...
        selectBorough(map, coronaData, 'total-cases', "Total Cases", "Total Number of Cases to 17 Mar")
