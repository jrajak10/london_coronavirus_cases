...
function addMapFeatures(map) {
    ...
    map.on('load', async function() {
        ...
        let coronaData = await fetchData('week58.json');
        ...
        selectBorough(map, coronaData, 'weekly-cases', "Cases in Last Week", "Number of Cases from 4-10 Oct")
        ...
        selectBorough(map, coronaData, 'total-cases', "Total Cases", "Total Number of Cases to 14 Oct")
