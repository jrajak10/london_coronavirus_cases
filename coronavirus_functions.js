...
async function getWeeks(currentBorough, data) {
    let weeks = ['week1.json', 'week2.json', 'week3.json', 'week4.json', 'week5.json', 'week6.json', 'week7.json', 'week8.json',
        ...
        'week25.json', 'week26.json', 'week27.json'
    ]
    ...
    let chart = new Chart(ctx, {
        ...
        data: {
            labels: [
                ...
                ['Feb 15-', 'Feb 21'], ['Feb 22-', 'Feb 28'], ['Mar 1-', 'Mar 7']
            ],
            datasets: [{
...
function addMapFeatures(map) {
    ...
    map.on('load', async function() {
        ...
        let coronaData = await fetchData('week27.json');
        ...
        selectBorough(map, coronaData, 'weekly-cases', "Cases in Last Week", "Number of Cases from 1st - 7th Mar")
        ...
        selectBorough(map, coronaData, 'total-cases', "Total Cases", "Total Number of Cases to 11th Mar")
