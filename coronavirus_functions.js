...
async function getWeeks(currentBorough, data) {
    let weeks = ['week1.json', 'week2.json', 'week3.json', 'week4.json', 'week5.json', 'week6.json', 'week7.json', 'week8.json',
            ...
            'week17.json', 'week18.json', 'week19.json', 'week20.json', 'week21.json']
...
function newChart(ctx, VARIABLES, previousWeeks, MAX_CHART_VALUES) {
    ...
    let chart = new Chart(ctx, {
        ...
        data: {
            ...
            ['Dec 28 - Jan 3'], ['Jan 4 - Jan 10'], ['Jan 11 - Jan 17'], ['Jan 18 - Jan 24']],
            datasets: [{
...
function addMapFeatures(map) {
    ...
    map.on('load', async function () {
        ...
        let coronaData = await fetchData('week21.json');
        ...
        selectBorough(map, coronaData, 'weekly-cases', "Cases in Last Week", "Number of Cases from 18th - 24th Jan")
        ...
        selectBorough(map, coronaData, 'total-cases', "Total Cases", "Total Number of Cases to 28th Jan")
