...
async function getWeeks(currentBorough, data) {
    let weeks = ['week1.json', 'week2.json', 'week3.json', 'week4.json', 'week5.json', 'week6.json', 'week7.json', 'week8.json',
            ...
            'week17.json', 'week18.json', 'week19.json', 'week20.json']
...
function newChart(ctx, VARIABLES, previousWeeks, MAX_CHART_VALUES) {
    ...
    let chart = new Chart(ctx, {
        ...
        data: {
            ...
            ['Dec 28 - Jan 3'], ['Jan 4 - Jan 10'], ['Jan 11 - Jan 17']],
            datasets: [{
...
function addMapFeatures(map) {
    ...
    map.on('load', async function () {
        ...
        let coronaData = await fetchData('week20.json');
        ...
        selectBorough(map, coronaData, 'weekly-cases', "Cases in Last Week", "Number of Cases from 11th - 17th Jan")
        ...
        selectBorough(map, coronaData, 'total-cases', "Total Cases", "Total Number of Cases to 21st Jan")
