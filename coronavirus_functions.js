...
async function getWeeks(currentBorough, data) {
    let weeks = ['week1.json', 'week2.json', 'week3.json', 'week4.json', 'week5.json', 'week6.json', 'week7.json', 'week8.json',
                'week9.json', 'week10.json', 'week11.json', 'week12.json', 'week13.json', 'week14.json', 'week15.json']
    ...
    let chart = new Chart(ctx, {
        ...
        data: {
            labels: [['Aug 31-', 'Sep 6'], ['Sep 7-', 'Sep 13'], ['Sep 14-', 'Sep 20'], ['Sep 21-', 'Sep 27'], 
                ...
                ['Nov 23- Nov 29'], ['Nov 30- Dec 6'], ['Dec 7-', 'Dec-13']],
            datasets: [{
...
function addMapFeatures(map) {
    ...
    map.on('load', async function () {
        ...
        let coronaData = await fetchData('week15.json');
        ...
        selectBorough(map, coronaData, 'weekly-cases', "Cases in Last Week", "Number of Cases from 7th - 13th Dec")
        ...
        selectBorough(map, coronaData, 'total-cases', "Total Cases", "Total Number of Cases to 17th Dec")
