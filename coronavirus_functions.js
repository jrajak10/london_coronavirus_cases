...
async function getWeeks(currentBorough, data) {
    let weeks = ['week1.json', 'week2.json', 'week3.json', 'week4.json', 'week5.json', 'week6.json', 'week7.json', 'week8.json',
        ...
        'week41.json', 'week42.json', 'week43.json', 'week44.json', 'week45.json', 'week46.json', 'week47.json'
    ]
    ...
    let chart = new Chart(ctx, {
        ...
        data: {
            labels: [
                ...
                ['Jul 5-', 'Jul 11'], ['Jul 12-', 'Jul 18'], ['Jul 19-', 'Jul 25']
            ],
            datasets: [{
...
function addMapFeatures(map) {
    ...
    map.on('load', async function() {
        ...
        let coronaData = await fetchData('week47.json');
        ...
        selectBorough(map, coronaData, 'weekly-cases', "Cases in Last Week", "Number of Cases from 19th - 25th July")
        ...
        selectBorough(map, coronaData, 'total-cases', "Total Cases", "Total Number of Cases to 29th July")
